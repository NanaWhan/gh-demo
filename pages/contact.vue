          ...
          <div class="col-span-1">
            ...
            <div class="space-y-6">
              <div class="flex items-start">
                <div
                  class="bg-accent bg-opacity-10 w-12 h-12 rounded-full flex items-center justify-center mr-4"
                >
                  <svg
                ...
                <div>
                  ...
                  <p class="text-gray-600 mt-1">
                    5 Cormorant Cl, Community 11, Tema
                  </p>
              ...
              <div class="flex items-start">
                ...
                <div>
                  ...
                  <p class="text-gray-600 mt-1">+233 (0)20 507 8908</p>
                  <p class="text-gray-600">+233 (0)30 278 6543</p>
                </div>
              </div>
              ...
              <div class="flex items-start">
                ...
                <div>
                  ...
                  <p class="text-gray-600 mt-1">info@glohorizonsgh.com</p>
                </div>
              </div>
            ...
            <div class="mt-8">
              ...
              <div class="flex space-x-4">
                <a
                  href="#"
                  class="bg-accent bg-opacity-10 w-10 h-10 rounded-full flex items-center justify-center text-accent hover:bg-opacity-20 transition"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5"
    ...
    <section class="py-16 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="bg-white p-4 rounded-2xl shadow-lg">
          ...
          >
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3970.6249687120396!2d-0.1855908!3d5.5761916!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNcKwMzQnMzQuMyJOIDDCsDExJzA4LjEiVw!5e0!3m2!1sen!2sgh!4v1621512345678!5m2!1sen!2sgh"
              width="100%"
              height="100%"
              style="border: 0"
              allowfullscreen=""
          ...
          <div class="bg-white p-4 rounded-lg shadow">
            ...
            <div v-show="openFaq === 1" class="mt-2 text-gray-600">
              <p>
                ...
                processing times are beyond our control. We do offer expedited
                services for urgent cases where possible.
              </p>
            </div>
          </div>
          ...
          <div class="bg-white p-4 rounded-lg shadow">
            ...
            <div v-show="openFaq === 2" class="mt-2 text-gray-600">
              <p>
                ...
                These can be scheduled in-person, by phone, or via video call.
              </p>
            </div>
          </div>
